...
import {
  ...
  Fuel, BedDouble, Link2, Trash2, Mail, Upload, LogOut, Paperclip
} from "lucide-react";
...
const TRANSLATIONS = {
  es: {
    tagline: "Organiza el viaje, entre todos.",
    email_label: "Correo electrónico",
    email_placeholder: "tucorreo@ejemplo.com",
    send_link: "Enviarme un enlace de acceso",
    sending: "Enviando...",
    magic_hint: "Sin contraseña: te enviamos un enlace mágico a tu correo para entrar.",
    check_email_title: "Revisa tu correo",
    check_email_body: "Te hemos enviado un enlace de acceso a {{email}}. Ábrelo desde este mismo dispositivo para entrar.",
    name_label: "Tu nombre",
    name_placeholder: "Xavi",
    continue: "Continuar",
    name_question: "¿Cómo te llamas?",
    hello: "Hola, {{name}}",
    new_trip: "Nuevo viaje",
    join: "Unirme",
    empty_trips: "Aún no tienes ningún viaje. Crea uno o únete con un código.",
    field_trip_name: "Nombre del viaje",
    trip_name_placeholder: "Escapada a Lisboa",
    field_destination: "Destino",
    destination_placeholder: "Lisboa, Portugal",
    field_days: "Número de días",
    field_transport: "Medio de transporte",
    field_people: "Número de personas (incluido tú)",
    create_trip: "Crear panel de viaje",
    creating: "Creando...",
    modal_new_trip: "Nuevo viaje",
    modal_join_trip: "Unirme a un viaje",
    field_join_code: "Código del viaje",
    joining: "Uniendo...",
    join_error: "No encuentro ningún viaje con ese código.",
    back_to_trips: "Todos los viajes",
    back_to_menu: "Menú del viaje",
    code_copied: "Código {{code}} copiado — compártelo con el grupo",
    nav_summary: "Resumen",
    ...
    add_your_doc: "Añadir tu {{noun}}",
    doc_field_placeholder: "Ej: Vuelo IB1234, enlace o nº de reserva",
    attach_receipt_optional: "Adjuntar foto (opcional)",
    no_entries_yet: "Nadie ha añadido su {{noun}} todavía.",
    fuel_total: "Gasto total en gasolina",
    add_refuel: "Añadir repostaje",
    fuel_place_placeholder: "Gasolinera / lugar",
    no_refuels_yet: "Ningún repostaje registrado todavía.",
    fuel_expense_concept: "Gasolina · {{place}}",
    field_accommodation_place: "Alojamiento",
    accommodation_place_placeholder: "Nombre del hotel / apartamento",
    field_accommodation_dates: "Fechas",
    accommodation_dates_placeholder: "Ej: 12–15 de septiembre",
    field_accommodation_roommates: "Reparto de habitaciones (quién va con quién)",
    accommodation_roommates_placeholder: "Ej: Xavi y Marta / Laia y Pol",
    field_accommodation_voucher: "Voucher / enlace de reserva",
    add_accommodation: "Añadir alojamiento",
    no_accommodation_yet: "Ningún alojamiento añadido todavía.",
    ...
    upload_file: "Subir un archivo (foto, PDF...)",
    uploading: "Subiendo...",
    doc_title_placeholder: "O añade un enlace: título",
    doc_url_placeholder: "Enlace",
    no_documents_yet: "Ningún documento añadido todavía.",
    added_by: "Añadido por {{name}}",
    settle_up_title: "Para saldar cuentas",
    settle_line: "{{from}} paga {{amount}} a {{to}}",
    label_owed: "le deben",
    label_owes: "debe",
    field_concept: "Concepto",
    concept_placeholder: "Ej: Cena del sábado",
    field_amount: "Importe",
    field_paid_by: "Pagado por",
    field_split_between: "Dividir entre",
    add_expense: "Añadir gasto",
    no_expenses_yet: "Ningún gasto registrado todavía.",
    paid_between: "{{payer}} pagó · entre {{count}}",
    view_receipt: "Ver ticket",
    transport_avion: "Avión", transport_tren: "Tren", transport_autobus: "Autobús",
    transport_barco: "Barco", transport_coche: "Coche compartido", transport_moto: "Moto",
    transport_bici: "Bicicleta", transport_individual: "Cada uno por su cuenta",
    noun_boarding_pass: "tarjeta de embarque", noun_ticket: "billete", noun_fuel_receipt: "ticket de gasolina",
  },
  ca: {
    tagline: "Organitza el viatge, entre tots.",
    email_label: "Correu electrònic",
    email_placeholder: "elteucorreu@exemple.com",
    send_link: "Envia'm un enllaç d'accés",
    sending: "Enviant...",
    magic_hint: "Sense contrasenya: t'enviem un enllaç màgic al correu per entrar.",
    check_email_title: "Revisa el teu correu",
    check_email_body: "T'hem enviat un enllaç d'accés a {{email}}. Obre'l des d'aquest mateix dispositiu per entrar.",
    name_label: "El teu nom",
    name_placeholder: "Xavi",
    continue: "Continuar",
    name_question: "Com et dius?",
    hello: "Hola, {{name}}",
    new_trip: "Nou viatge",
    join: "Unir-me",
    empty_trips: "Encara no tens cap viatge. Crea'n un o uneix-te amb un codi.",
    field_trip_name: "Nom del viatge",
    trip_name_placeholder: "Escapada a Lisboa",
    field_destination: "Destinació",
    destination_placeholder: "Lisboa, Portugal",
    field_days: "Nombre de dies",
    field_transport: "Mitjà de transport",
    field_people: "Nombre de persones (inclòs tu)",
    create_trip: "Crear panell de viatge",
    creating: "Creant...",
    modal_new_trip: "Nou viatge",
    modal_join_trip: "Unir-me a un viatge",
    field_join_code: "Codi del viatge",
    joining: "Unint...",
    join_error: "No trobo cap viatge amb aquest codi.",
    back_to_trips: "Tots els viatges",
    back_to_menu: "Menú del viatge",
    code_copied: "Codi {{code}} copiat — comparteix-lo amb el grup",
    nav_summary: "Resum",
    nav_transport: "Transport",
    nav_accommodation: "Allotjament",
    ...
    add_your_doc: "Afegeix el teu {{noun}}",
    doc_field_placeholder: "Ex: Vol IB1234, enllaç o núm. de reserva",
    attach_receipt_optional: "Adjuntar foto (opcional)",
    no_entries_yet: "Ningú ha afegit el seu {{noun}} encara.",
    fuel_total: "Despesa total en gasolina",
    add_refuel: "Afegir repostatge",
    fuel_place_placeholder: "Gasolinera / lloc",
    no_refuels_yet: "Cap repostatge registrat encara.",
    fuel_expense_concept: "Gasolina · {{place}}",
    field_accommodation_place: "Allotjament",
    accommodation_place_placeholder: "Nom de l'hotel / apartament",
    field_accommodation_dates: "Dates",
    accommodation_dates_placeholder: "Ex: 12–15 de setembre",
    field_accommodation_roommates: "Repartiment d'habitacions (qui va amb qui)",
    accommodation_roommates_placeholder: "Ex: Xavi i Marta / Laia i Pol",
    field_accommodation_voucher: "Voucher / enllaç de reserva",
    add_accommodation: "Afegir allotjament",
    no_accommodation_yet: "Cap allotjament afegit encara.",
    ...
    upload_file: "Pujar un arxiu (foto, PDF...)",
    uploading: "Pujant...",
    doc_title_placeholder: "O afegeix un enllaç: títol",
    doc_url_placeholder: "Enllaç",
    no_documents_yet: "Cap document afegit encara.",
    added_by: "Afegit per {{name}}",
    settle_up_title: "Per saldar comptes",
    settle_line: "{{from}} paga {{amount}} a {{to}}",
    label_owed: "li deuen",
    label_owes: "deu",
    field_concept: "Concepte",
    concept_placeholder: "Ex: Sopar de dissabte",
    field_amount: "Import",
    field_paid_by: "Pagat per",
    field_split_between: "Dividir entre",
    add_expense: "Afegir despesa",
    no_expenses_yet: "Cap despesa registrada encara.",
    paid_between: "{{payer}} va pagar · entre {{count}}",
    view_receipt: "Veure tiquet",
    transport_avion: "Avió", transport_tren: "Tren", transport_autobus: "Autobús",
    transport_barco: "Vaixell", transport_coche: "Cotxe compartit", transport_moto: "Moto",
    transport_bici: "Bicicleta", transport_individual: "Cadascú pel seu compte",
  ...
  en: {
    ...
    send_link: "Send me a login link",
    sending: "Sending...",
    magic_hint: "No password: we'll email you a magic link to sign in.",
    check_email_title: "Check your inbox",
    check_email_body: "We've sent a login link to {{email}}. Open it on this same device to sign in.",
    ...
    new_trip: "New trip",
    join: "Join",
    empty_trips: "No trips yet. Create one or join with a code.",
    field_trip_name: "Trip name",
    trip_name_placeholder: "Weekend in Lisbon",
    field_destination: "Destination",
    destination_placeholder: "Lisbon, Portugal",
    field_days: "Number of days",
    field_transport: "Mode of transport",
    field_people: "Number of people (including you)",
    create_trip: "Create trip panel",
    creating: "Creating...",
    modal_new_trip: "New trip",
    modal_join_trip: "Join a trip",
    field_join_code: "Trip code",
    joining: "Joining...",
    join_error: "Couldn't find a trip with that code.",
    back_to_trips: "All trips",
    back_to_menu: "Trip menu",
    code_copied: "Code {{code}} copied — share it with the group",
    nav_summary: "Summary",
    nav_transport: "Transport",
    ...
    add_your_doc: "Add your {{noun}}",
    doc_field_placeholder: "E.g. Flight IB1234, link or booking ref.",
    attach_receipt_optional: "Attach a photo (optional)",
    no_entries_yet: "Nobody has added their {{noun}} yet.",
    fuel_total: "Total fuel spend",
    add_refuel: "Add fuel stop",
    fuel_place_placeholder: "Gas station / place",
    no_refuels_yet: "No fuel stops logged yet.",
    fuel_expense_concept: "Fuel · {{place}}",
    field_accommodation_place: "Accommodation",
    accommodation_place_placeholder: "Hotel / apartment name",
    field_accommodation_dates: "Dates",
    accommodation_dates_placeholder: "E.g. Sept 12-15",
    field_accommodation_roommates: "Room split (who's with whom)",
    accommodation_roommates_placeholder: "E.g. Xavi & Marta / Laia & Pol",
    field_accommodation_voucher: "Voucher / booking link",
    add_accommodation: "Add accommodation",
    no_accommodation_yet: "No accommodation added yet.",
    ...
    upload_file: "Upload a file (photo, PDF...)",
    uploading: "Uploading...",
    doc_title_placeholder: "Or add a link: title",
    doc_url_placeholder: "Link",
    no_documents_yet: "No documents added yet.",
    added_by: "Added by {{name}}",
    settle_up_title: "To settle up",
    settle_line: "{{from}} pays {{amount}} to {{to}}",
    label_owed: "is owed",
    label_owes: "owes",
    field_concept: "Concept",
    concept_placeholder: "E.g. Saturday dinner",
    field_amount: "Amount",
    field_paid_by: "Paid by",
    field_split_between: "Split between",
    add_expense: "Add expense",
    no_expenses_yet: "No expenses logged yet.",
    paid_between: "{{payer}} paid · split {{count}}",
    view_receipt: "View receipt",
    transport_avion: "Plane", transport_tren: "Train", transport_autobus: "Bus",
    transport_barco: "Ferry", transport_coche: "Shared car", transport_moto: "Motorbike",
    transport_bici: "Bicycle", transport_individual: "Everyone on their own",
    ...
    <div style={{ display: "flex", gap: 4, background: dark ? "transparent" : COLORS.paperDim, borderRadius: 999, padding: 3 }}>
      {LANGS.map((l) => (
        <button key={l} type="button" onClick={() => onChange(l)} style={{
          border: dark ? `1.5px solid ${lang === l ? COLORS.paper : COLORS.paper + "55"}` : "none",
          borderRadius: 999, padding: "5px 10px", cursor: "pointer",
          fontFamily: "'Space Grotesk', sans-serif", fontSize: 11.5, fontWeight: 700,
          background: dark ? "transparent" : (lang === l ? COLORS.ink : "transparent"),
          color: dark ? COLORS.paper : (lang === l ? COLORS.paper : COLORS.inkLight),
        }}>{LANG_LABEL[l]}</button>
      ))}
    </div>
  );
    ...
    <div style={{ minHeight: "100%", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, textAlign: "center" }}>
      <div style={{ maxWidth: 380, background: COLORS.paper, borderRadius: 20, padding: "36px 30px" }}>
        ...
        <p style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 14, color: COLORS.inkLight }}>
          {t(lang, "check_email_body", { email: `<strong>${email}</strong>` }).split("<strong>")[0]}
          <strong>{email}</strong>
          {t(lang, "check_email_body", { email: "" }).split(email)[1] || ""}
        </p>
      </div>
    </div>
  );
  ...
  return (
    <ModalShell title={t(lang, "modal_new_trip")} onClose={onClose}>
      <form onSubmit={submit}>
        <Field label={t(lang, "field_trip_name")}>
          <input style={inputStyle} required value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} placeholder={t(lang, "trip_name_placeholder")} />
        </Field>
        <Field label={t(lang, "field_destination")}>
          <input style={inputStyle} required value={form.destination} onChange={(e) => setForm({ ...form, destination: e.target.value })} placeholder={t(lang, "destination_placeholder")} />
        </Field>
        <Field label={t(lang, "field_days")}>
        ...
        <Field label={t(lang, "field_people")}>
        ...
        <Btn type="submit" disabled={saving} style={{ width: "100%", justifyContent: "center", marginTop: 4 }}>
          {saving ? t(lang, "creating") : t(lang, "create_trip")}
        </Btn>
      </form>
    </ModalShell>
  );
...
function JoinTripModal({ lang, onClose, onJoin }) {
  ...
  const submit = async (e) => {
    ...
    setSaving(false);
    if (!ok) setError(t(lang, "join_error"));
  };
  return (
...
// ---------------------------------------------------------------------------
// Trip detail — screen-based navigation
// ---------------------------------------------------------------------------
const SECTIONS = [
...
function SectionTile({ section, lang, onOpen }) {
  ...
  return (
    <button onClick={onOpen} style={{
      ...
      background: COLORS.paper, border: "none", borderRadius: 16, padding: "26px 14px", cursor: "pointer",
      boxShadow: "0 8px 20px rgba(0,0,0,0.2)", transition: "transform 0.15s ease",
    }}
      ...
      <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 14, fontWeight: 600, color: COLORS.ink }}>{t(lang, section.labelKey)}</span>
    </button>
  );
}
...
function TripDetail({ tripId, lang, displayName, onBack, onToast }) {
  ...
  const copyCode = () => {
    ...
    onToast(t(lang, "code_copied", { code: trip.code }));
  };

  return (
    <div style={{ maxWidth: 920, margin: "0 auto", padding: "26px 24px 90px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12, marginBottom: 22 }}>
        <div>
          ...
          <div style={{ display: "flex", marginTop: 10 }}>
            {members.map((m, i) => (
              <div key={m} style={{ marginLeft: i === 0 ? 0 : -8 }} title={m}><Avatar name={m} members={members} size={28} /></div>
            ))}
          </div>
        </div>
      ...
      {!section ? (
        ...
        <div style={{ background: COLORS.paper, borderRadius: 18, padding: 26 }}>
          ...
          {section === "transporte" && (
            <TransporteTab tripId={tripId} opt={opt} displayName={displayName} lang={lang}
          ...
          {section === "costes" && (
            <CostesTab tripId={tripId} lang={lang} displayName={displayName} members={members} expenses={expenses} onReload={load} />
          )}
        </div>
      )}
    </div>
  ...
  return (
    <div>
      <p style={{ fontFamily: "'Space Grotesk', sans-serif", color: COLORS.ink, lineHeight: 1.7 }}>
        {t(lang, "summary_body", {
          count: members.length, plural: members.length !== 1 ? (lang === "en" ? "" : "s") : "",
          name: trip.name, destination: trip.destination, days: trip.days, transport: t(lang, opt.labelKey).toLowerCase(),
        })}
      </p>
      <TicketDivider />
...
function ReceiptPicker({ lang, file, setFile }) {
  return (
    <label style={{ display: "flex", alignItems: "center", gap: 8, fontFamily: "'Space Grotesk', sans-serif", fontSize: 12.5, color: COLORS.inkLight, cursor: "pointer", marginTop: -4, marginBottom: 14 }}>
      <Paperclip size={14} />
      <span>{file ? file.name : t(lang, "attach_receipt_optional")}</span>
...
function TransporteTab({ tripId, opt, displayName, lang, transportEntries, fuelEntries, members, onReload }) {
    ...
    return (
      <div style={{ textAlign: "center", padding: "20px 0" }}>
        ...
        <p style={{ fontFamily: "'Space Grotesk', sans-serif", color: COLORS.ink, marginTop: 10 }}>
          {t(lang, "none_transport_text", { transport: t(lang, opt.labelKey).toLowerCase() })}
        </p>
      </div>
    );
  }
  ...
  if (opt.category === "ticket") {
    ...
    const addEntry = async () => {
      ...
      if (ticketFile) { const up = await uploadReceipt(tripId, ticketFile); if (up) receipt_url = up.url; }
      await supabase.from("transport_entries").insert({ trip_id: tripId, member: displayName, info: info.trim(), receipt_url });
      if (receipt_url) await supabase.from("documents").insert({ trip_id: tripId, title: `${noun} · ${displayName}`, url: receipt_url, added_by: displayName });
      setInfo(""); setTicketFile(null); setBusy(false);
      onReload();
    };
    return (
      <div>
        <Field label={t(lang, "add_your_doc", { noun })}>
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <Btn onClick={addEntry} disabled={busy}><Plus size={15} /></Btn>
          </div>
        </Field>
  ...
  const addFuel = async () => {
    ...
    setBusy(true);
    let receipt_url = null;
    if (fuelFile) { const up = await uploadReceipt(tripId, fuelFile); if (up) receipt_url = up.url; }
    await supabase.from("fuel_entries").insert({ trip_id: tripId, member: displayName, place: fuel.place.trim(), amount: Number(fuel.amount), receipt_url });
    await supabase.from("expenses").insert({
      trip_id: tripId, concept: t(lang, "fuel_expense_concept", { place: fuel.place.trim() }),
      amount: Number(fuel.amount), payer: displayName, split: members,
    });
    if (receipt_url) await supabase.from("documents").insert({ trip_id: tripId, title: `${t(lang, opt.nounKey)} · ${fuel.place.trim()}`, url: receipt_url, added_by: displayName });
    setFuel({ place: "", amount: "" }); setFuelFile(null); setBusy(false);
    onReload();
  };
  return (
    <div>
      ...
      <Field label={t(lang, "add_refuel")}>
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          <Btn onClick={addFuel} disabled={busy}><Plus size={15} /></Btn>
        </div>
      </Field>
...
function AlojamientoTab({ tripId, lang, accommodations, onReload }) {
  ...
  return (
    <div>
      <Field label={t(lang, "field_accommodation_place")}>
        <input style={inputStyle} value={form.place} onChange={(e) => setForm({ ...form, place: e.target.value })} placeholder={t(lang, "accommodation_place_placeholder")} />
      </Field>
      <Field label={t(lang, "field_accommodation_dates")}>
        <input style={inputStyle} value={form.dates} onChange={(e) => setForm({ ...form, dates: e.target.value })} placeholder={t(lang, "accommodation_dates_placeholder")} />
      </Field>
      <Field label={t(lang, "field_accommodation_roommates")}>
        <input style={inputStyle} value={form.roommates} onChange={(e) => setForm({ ...form, roommates: e.target.value })} placeholder={t(lang, "accommodation_roommates_placeholder")} />
      </Field>
      <Field label={t(lang, "field_accommodation_voucher")}>
        <input style={inputStyle} value={form.notes} onChange={(e) => setForm({ ...form, notes: e.target.value })} />
      </Field>
      <Btn onClick={add}><Plus size={15} /> {t(lang, "add_accommodation")}</Btn>
      <TicketDivider />
  ...
  return (
    <div>
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          {settlements.map((s, i) => (
            <div key={i} style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 13.5, color: COLORS.ink, marginBottom: 4 }}>
              {t(lang, "settle_line", { from: s.from, to: s.to, amount: fmtMoney(s.amount) })}
            </div>
          ))}
        </div>
      )}
      ...
      <div style={{ marginBottom: 18 }}>
        <Field label={t(lang, "field_concept")}>
          <input style={inputStyle} value={form.concept} onChange={(e) => setForm({ ...form, concept: e.target.value })} placeholder={t(lang, "concept_placeholder")} />
        </Field>
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
          <div style={{ flex: 1, minWidth: 100 }}>
            <Field label={t(lang, "field_amount")}>
        ...
        <Btn onClick={addExpense}><Plus size={15} /> {t(lang, "add_expense")}</Btn>
      </div>
        ...
        {[...expenses].reverse().map((e) => (
          <div key={e.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: COLORS.paperDim, borderRadius: 10, padding: "10px 12px" }}>
            <div>
              ...
              <div style={{ fontFamily: "'Space Grotesk', sans-serif", fontSize: 11.5, color: COLORS.inkLight }}>{t(lang, "paid_between", { payer: e.payer, count: e.split.length })}</div>
            </div>
...
export default function App() {
  ...
  const setLang = async (l) => {
    setLangState(l);
    if (session) await supabase.auth.updateUser({ data: { locale: l } });
  };
  ...
  if (session === undefined) {
    ...
    body = pendingEmail ? <CheckEmailScreen lang={lang} email={pendingEmail} /> : <LoginScreen lang={lang} setLang={setLang} onSent={setPendingEmail} />;
  } else if (!displayName) {
    body = <NameScreen lang={lang} onSet={() => setSession({ ...session })} />;
  } else if (activeTrip) {
    body = (
      <TripDetail tripId={activeTrip.id} lang={lang} displayName={displayName} onBack={() => setActiveTrip(null)} onToast={showToast} />
    );
  } else {
    body = (
      <Dashboard
        ...
        trips={trips}
        onOpenTrip={(code) => {
          const tr = trips.find((x) => x.code === code);
          if (tr) setActiveTrip({ id: tr.id, code: tr.code });
        }}
