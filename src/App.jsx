...
const ROUTE_MODES = [
  { id: "walking", icon: Footprints, labelKey: "route_mode_walking" },
  { id: "cycling", icon: Bike, labelKey: "route_mode_cycling" },
  { id: "driving", icon: Car, labelKey: "route_mode_driving" },
];
  ...
  return (
    <div>
      ...
      <div style={{ borderRadius: 14, overflow: "hidden", marginBottom: 10, border: `1.5px solid ${COLORS.inkLight}33` }}>
        <MapContainer center={center} zoom={12} style={{ height: 340, width: "100%" }} key={center.join(",")}>
